...
static AIBinder_Class* get_g_aidl_android_aidl_versioned_tests_IFooInterface_clazz() {
  ...
  static AIBinder_Class* clazz = ::ndk::ICInterface::defineClass(IFooInterface::descriptor, _aidl_android_aidl_versioned_tests_IFooInterface_onTransact, get_g_aidl_android_aidl_versioned_tests_IFooInterface_clazz_names, 4);
  return clazz;
}
